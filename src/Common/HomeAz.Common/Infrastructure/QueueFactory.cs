...
namespace HomeAz.Common.Infrastructure
{
    public static class QueueFactory
    {
        ...
        {
            var factory = new ConnectionFactory() { HostName = HomeAzConstants.RabbitMqHost };
        ...
        public static EventingBasicConsumer EnsureExchange(this EventingBasicConsumer consumer,
                                                           string exchangeName,
                                                           string exchangeType = HomeAzConstants.DefaultExchangeType)
        {
